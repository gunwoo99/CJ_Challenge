...
class CJ_Cluster:
    def __init__(self, order_list, distance_matrix, vertex_to_index, terminal_site):
        ...
        # print("order_site", orders_site)
        # print("order_destination", orders_destination)
        # print("clustered_order_site_indices_set", self.clustered_order_site_indices_set)
        for i in range(self.cluster_number):
            ...
            # print("index_site_number",index_site_number)
            ...
            # print("result", result)
            # print("same_Site_orders", same_site_orders_indices)
